...
🖼️ **Image needed:** a box diagram — one pod/host containing two boxes side by side ("App"
and "Sidecar"), with an arrow showing outside traffic hitting the Sidecar first before
reaching the App. Search: "sidecar pattern service mesh diagram".
